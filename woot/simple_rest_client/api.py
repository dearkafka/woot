...
from woot.simple_rest_client.resource import Resource
...
class API:
    ...
    def add_resource(
        ...
        resource = resource_class(
            ...
            else self.append_slash,
            json_encode_body=json_encode_body
            if json_encode_body is not None
            else self.json_encode_body,
